...
for i in range(start_from // save_every_n_epoch, n_epochs // save_every_n_epoch):
    ...
    model.save_weights("../weights/implementation8-deep-" + str(i * save_every_n_epoch) + ".h5")

    # save sample images
    whole_image_check_overlapping(model, 40, "imp8-deep-" + str(i * save_every_n_epoch) + "-")

    # save history
    output = open('../history/imp8-deep-{:0=4d}.pkl'.format(i * save_every_n_epoch), 'wb')
