...
x = Conv2D(64, (3, 3), padding="same", activation="relu", kernel_regularizer=regularizers.l2(0.01))(main_input)
...
for i in range(start_from // save_every_n_epoch, n_epochs // save_every_n_epoch):
    ...
    model.save_weights("../weights/implementation8-poola-" + str(i * save_every_n_epoch) + ".h5")

    # save sample images
    whole_image_check_overlapping(model, 40, "imp8-poola-" + str(i * save_every_n_epoch) + "-")

    # save history
    output = open('../history/imp8-poola-{:0=4d}.pkl'.format(i * save_every_n_epoch), 'wb')
