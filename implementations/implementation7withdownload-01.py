...
def normalize(x):
    # this function normalizes data to be between [0, 1]
    return x / 100

# main network
main_input = Input(shape=input_shape, name='image_part_input')

x = Lambda(normalize)(main_input)
...
n_epochs = 10000
model.load_weights("../weights/implementation7d-01-20.h5")
...
for i in range(start_from // save_every_n_epoch, n_epochs // save_every_n_epoch):
    ...
    # save sample images
    whole_image_check(model, 20, "imp7d-01-" + str(i * save_every_n_epoch) + "-")
